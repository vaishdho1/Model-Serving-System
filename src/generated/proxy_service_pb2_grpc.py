...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in proxy_service_pb2_grpc.py depends on'
...
def add_HealthServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'protos.HealthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('protos.HealthService', rpc_method_handlers)
